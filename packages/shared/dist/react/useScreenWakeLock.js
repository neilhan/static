...
import { getDocument, getNavigatorWithWakeLock, getWindow, isBrowserEnv, isMobileDevice, supportsWakeLock, } from "../wakeLockEnv";
const defaultEnvSnapshot = () => ({
    envReady: isBrowserEnv(),
    isMobile: isMobileDevice(),
    wakeLockSupported: supportsWakeLock(),
});
export const useScreenWakeLock = (shouldHold) => {
